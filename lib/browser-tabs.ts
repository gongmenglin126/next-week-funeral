...
export const BROWSER_URLS: Record<string, string> = {
  ...
  "survivor-index": "wusou-index.example/pages/wuting-talk/rain-after",
  ...
  "gu-unpublished": "haizhou-audio.example/archive/hear-me",
  ...
  "daluo-biography": "linchuan-memory.example/texts/wuxiang-zun",
  "beilu-oral-history": "linchuan-memory.example/projects/beilu-old-hospital",
...
export const BROWSER_LABELS: Record<string, string> = {
  ...
  "daluo-biography": "地方文献",
  "beilu-oral-history": "北麓旧院",
  biography: "顾惟真自传",
  "lu-memorial": "旧报归档",
  hospital: "海岬和济",
