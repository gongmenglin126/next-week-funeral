export const TRAVEL_PHOTOS = [
  { id: "IMG_4819.jpg", src: "/game/seaside-dinner.webp", time: "8月24日 17:42", location: "栖潮餐厅", alt: "雨窗旁摆着两人份的晚餐", cropped: false },
  { id: "IMG_4820.jpg", src: "/game/wuting-sea-wallpaper.webp", time: "8月24日 17:43", location: "雾汀老城", alt: "雨天的雾汀海岸，与电脑桌面相同的照片", cropped: false },
] as const;

export const DELETED_PHOTO = {
  id: "IMG_4821_crop.jpg", src: "/game/inn-corridor-original.webp",
