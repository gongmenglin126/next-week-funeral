...
export function CommunityPage({ onOpenWitness, onOpenFoundation }: { onOpenWitness: () => void; onOpenFoundation: () => void }) {
  return <div className="community-page"><CommunityHeader /><main>
    <section className="community-feed" aria-label="匿名文字记录"><div className="community-section-title"><h1>最近留下的文字</h1><span>按发布时间</span></div>
      <article className="community-entry community-entry-own"><header><strong>潮汐失眠</strong><time>6月19日 23:48</time></header><p>复查结果出来了。医生说原来的方案效果不太好了，我不知道该怎么跟最亲近的人开口。病例上的姓名和门诊号已经遮掉，只想问问，我这种情况还能活多久。</p><div className="medical-attachment" aria-label="潮汐失眠上传的肿瘤科复诊记录"><header><strong>临川市第二医院</strong><span>肿瘤科门诊复诊记录 · 节选</span></header><dl><div><dt>姓名</dt><dd>周＊＊</dd></div><div><dt>主要诊断</dt><dd>胃低分化腺癌</dd></div><div><dt>复查情况</dt><dd>腹膜及肝脏多发转移，较前进展</dd></div><div><dt>处理建议</dt><dd>结合临床情况评估后续治疗方案</dd></div></dl><small>姓名、门诊号及医师签名已由上传者遮挡</small></div></article>
...
export function SurvivorProfile({ obituarySeen, onRevisionFound }: { obituarySeen: boolean; onRevisionFound: () => void }) {
  return <div className="survivor-page"><header><strong>雾汀同城</strong><span>用户资料</span></header><main><section className="survivor-profile"><div className="survivor-avatar">雨</div><div><h1>雨停以后</h1><p>第六期活动参与者｜安时活动志愿答疑</p><small>账号当前仅展示 · 互动功能受限</small></div></section><details className="profile-history-toggle"><summary>查看资料修改记录</summary><section className="profile-history" aria-label="资料修改记录"><div><time>8月18日 09:03</time><p>个人简介修改为“第六期活动参与者｜安时活动志愿答疑”</p></div><div><time>7月2日 01:14</time><p>原简介：肺腺癌晚期。只是记录，不卖东西。<strong>米粒</strong>是一只猫。</p></div></section></details><section className="profile-posts"><h2>公开动态</h2><article><time>8月19日 09:00</time><p>今天状态还可以，谢谢大家关心。之后会慢慢恢复更新。</p></article><article><time>8月16日 02:11</time><p><strong>临潮重症援助</strong>帮忙协调到了床位，明天住院。最近没力气，<strong>米粒</strong>一直挨着我，可能不会再更。</p></article><article><time>8月9日 01:47</time><p>今天吐得厉害，半夜还是想吃码头那家的甜豆花。<strong>米粒</strong>把药盒推到地上以后，就一直趴在床边。</p></article></section>{obituarySeen ? <details className="profile-history-toggle" onToggle={(event) => { if (event.currentTarget.open) onRevisionFound(); }}><summary>网页缓存：此页存在两个版本</summary><section className="profile-history" aria-label="公开页面版本差异"><div><time>8月17日 03:26</time><p>治丧信息记录程叙白病逝。</p></div><div><time>8月18日 09:03</time><p>维护账号 <strong>RC-03</strong> 接管资料，改写个人简介。</p></div><div><time>8月19日 09:00</time><p>账号以原用户口吻发布“今天状态还可以”。</p></div><div><time>R-06-4</time><p>内部修订备注：不增补死亡信息；保留原账号语气与更新频率，继续公开回访。</p></div></section></details> : null}</main></div>;
}
