...
export function CommunityPage({ onOpenWitness, onOpenFoundation }: { onOpenWitness: () => void; onOpenFoundation: () => void }) {
  return <div className="community-page"><CommunityHeader /><main>
    <section className="community-feed" aria-label="匿名文字记录"><div className="community-section-title"><h1>最近留下的文字</h1><span>按发布时间</span></div>
      <article className="community-entry community-entry-own"><header><strong>潮汐失眠</strong><time>6月19日 23:48</time></header><p>复查结果出来了。医生说已经没有治愈的可能，剩下的时间可能不到半年。我不知道该怎么跟最亲近的人开口。接下来该怎么办，我一点头绪都没有。</p><div className="medical-attachment" aria-label="潮汐失眠上传的肿瘤科复诊记录"><header><strong>临川市第二医院</strong><span>肿瘤科门诊复诊记录 · 节选</span></header><dl><div><dt>姓名</dt><dd>周＊＊</dd></div><div><dt>主要诊断</dt><dd>胃低分化腺癌 IV期</dd></div><div><dt>复查情况</dt><dd>腹膜及肝脏多发转移，治疗后继续进展</dd></div><div><dt>病情评估</dt><dd>疾病终末期，预计生存期不足六个月</dd></div><div><dt>处理建议</dt><dd>建议转入姑息治疗，以疼痛及症状控制为主</dd></div></dl></div></article>
