    ...
    <div className="mx-auto max-w-[920px] overflow-hidden border border-white/15 bg-[#202424] shadow-[0_24px_60px_rgba(0,0,0,.28)]">
      ...
      <main className="px-7 py-10 md:px-12 md:py-14">
        ...
        <section className="mt-10 space-y-7 border-y border-white/10 py-9 text-[15px] leading-8 text-white/72">
          ...
          <p><strong className="mr-2 text-white/42">孟嘉：</strong>......你能保证每次都给他们带来奇迹吗？</p>
  ...
  return <article className="min-h-full bg-[#f3efe8] text-[#292d2a]">
    ...
    <main className="mx-auto max-w-[980px] px-7 py-10 md:px-12 md:py-14">
      ...
      <div className="mx-auto mt-12 max-w-[700px] space-y-7 font-serif text-[15px] leading-[2.05] text-[#3c403c]">
        ...
        <p>顾惟真把盒盖重新合上：“2016年以后就没有再用过。你不提醒，我都快忘了它们还在。”</p>

        <p>桌上倒很简单：几份当天的文件，一只茶杯，一支用了很多年的钢笔。我们问他平时会不会专门坐在这里读书，他想了想，说其实更多时候只是回来坐一会儿，“翻两页，接个电话，天就黑了”。</p>

        <p>临走前，他把我们刚看过的一册地方旧志重新塞回书架。位置显然不对，我刚想开口提醒，他对我摆了摆手，笑着说：“每次采访我都会打乱一下摆放，也不失为一种乐趣。”</p>
      </div>
