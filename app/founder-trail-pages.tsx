...
const CHAPTERS = [
  {
    number: "01",
    title: "山脚",
    summary: "关于临川旧城、家中佛堂，以及顾惟真持续三十余年的礼佛生活。",
    excerpt: "顾惟真说，他不是逢年过节才去拜一拜。少年时母亲住院，他每天放学后在家中观音像前抄《心经》，一直抄到母亲出院。后来家里专门辟出一间佛堂；每月初一、十五茹素，清晨五点半上香，晚上回家再换一次净水。创业最忙的几年，他出差仍随身带着念珠和一册折叠经本，酒店住得久了，会先在窗边收拾出一块干净地方。这个习惯持续了三十多年，直到四十五岁。",
  },
  ...
  { number: "05", title: "停下来的一年", summary: "2016年，他第一次离开公司管理岗位。" },
  {
    number: "06",
    title: "病房外的时间",
    summary: "康复后撤去佛堂、处置旧藏，以及成立生命关怀项目的想法。",
    excerpt: "从海岬出院回家后，顾惟真先让人撤去佛堂里的供桌，又停掉了持续多年的寺院供养。三个月后，他把历年收藏和家中供奉过的佛像、经卷与法器集中委托嘉闻拍卖，编成“澜序旧藏·佛教艺术”专场；只留下最早的一只香炉和出差常带的念珠，装进箱底。顾惟真说：“我没有砸，也没有烧。供奉过的东西也没有错，但我不能再对着它们假装还有谁在听。”",
  },
] as const;
